...
SELECT CONCAT('O projeto ', Name, ' precisou de ', Hours, ' horas para ser concluído.') AS 'Tempo de conclusão por projeto' FROM Scientists.Projects;
