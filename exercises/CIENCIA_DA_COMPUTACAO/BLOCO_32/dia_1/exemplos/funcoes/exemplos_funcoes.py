...
# Os parâmetros também podem ser variádicos. Ou seja,
# podem variar em sua quantidade.
# Parâmetros posicionais variádicos são acessados
# como tuplas no interior de uma
# função e parâmetros nomeados variádicos como dicionário.
...
# Escopo de função
number = 10  # Escopo global


def increment(number):
    number += 1  # Escopo local
    return number
