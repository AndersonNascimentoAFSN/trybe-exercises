...
# Listas (list) # elementos são definidos separados por vírgula, envolvidos por colchetes

fruits = ['orange', 'apple', 'grape', 'pineapple'];
print(type(fruits));

# Tuplas (tuple) # elementos são definidos separados por vírgula, envolvidos por parenteses
...
print(permissions.union({"user"})); # novos conjuntos imutáveis podem ser criados à partir do original, mas o mesmo não pode ser modificado
...
print(type(range(5)));
print(list(range(5))); # definimos somente o valor de parada
print(list(range(1, 6))); # definimos o valor inicial e o de parada
print(list(range(1, 11, 2))); # definimos valor inicial, de parada e modificamos o passo para 2
print(list(range(10, 0, -1))); # podemos utilizar valores negativos para as entradas também